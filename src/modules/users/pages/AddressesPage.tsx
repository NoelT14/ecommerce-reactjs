...
// ─── Mock data — replace with GET /users/addresses ────────────────────────────
const MOCK_ADDRESSES: Address[] = [
  { id: 'a1', type: 'shipping', fullName: 'John Doe',   phone: '+1 555-0100', addressLine1: '123 Main St',     addressLine2: 'Apt 4B',  city: 'New York',    country: 'US', postalCode: '10001', isDefault: true  },
  { id: 'a2', type: 'shipping', fullName: 'John Doe',   phone: '+1 555-0100', addressLine1: '456 Oak Ave',     addressLine2: null,      city: 'Los Angeles', country: 'US', postalCode: '90001', isDefault: false },
  { id: 'a3', type: 'billing',  fullName: 'John Doe',   phone: '+1 555-0100', addressLine1: '789 Pine Rd',     addressLine2: 'Suite 1', city: 'Chicago',     country: 'US', postalCode: '60601', isDefault: true  },
]
...
export default function AddressesPage() {
  ...
  // TODO: replace local state operations with API calls:
  // Create: POST /users/addresses
  // Update: PATCH /users/addresses/:id
  // Delete: DELETE /users/addresses/:id
  // Set default: PATCH /users/addresses/:id/default
  ...
  const handleSave = () => {
    if (editingAddress) {
      setAddresses((prev) => prev.map((a) => a.id === editingAddress.id ? { ...editingAddress, ...form } : a))
    } else {
      setAddresses((prev) => [...prev, { id: `a${Date.now()}`, ...form }])
    }
    setModalOpen(false)
  }
  ...
  const handleSetDefault = (id: string, type: AddressType) => {
    setAddresses((prev) =>
      prev.map((a) => a.type === type ? { ...a, isDefault: a.id === id } : a)
    )
  }
